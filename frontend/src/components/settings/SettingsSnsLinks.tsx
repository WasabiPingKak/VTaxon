...
export default function SettingsSnsLinks() {
  ...
  async function handleSaveSns(e: React.FormEvent) {
    e.preventDefault();
    setSavingSns(true);
    try {
      const updated = await api.updateMe({ social_links: socialLinks } as Parameters<typeof api.updateMe>[0]);
      setUser(updated);
        ...
        <div key={key} style={{ marginBottom: '10px' }}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: '4px', fontSize: '1em', boxSizing: 'border-box' as const,
