...
export interface BreedInterceptSpecies extends SpeciesInfo {
  _breeds: Breed[];
  _speciesInfo: SpeciesInfo;
}

export interface BreedSelectPayload extends SpeciesInfo {
  result_type: 'breed';
  breed: Breed;
}

export interface BreedInterceptPanelProps {
  species: BreedInterceptSpecies;
  onSelectBreed: (payload: BreedSelectPayload) => void;
  onSkip: () => void;
  onCancel: () => void;
  hasSearchedLatin: boolean;
}

export default function BreedInterceptPanel({ species, onSelectBreed, onSkip, onCancel, hasSearchedLatin }: BreedInterceptPanelProps) {
  ...
  function handleSelectBreed(breed: Breed) {
    const payload: BreedSelectPayload = {
      result_type: 'breed',
