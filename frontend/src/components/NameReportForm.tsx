...
interface NameReportFormProps {
  results: SearchResult[] | null;
  onClose: () => void;
}

export default function NameReportForm({ results, onClose }: NameReportFormProps): React.ReactElement {
  const [selectedTaxonId, setSelectedTaxonId] = useState<string>('');
  const [reportType, setReportType] = useState<string>('missing_zh');
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSuggestedName(e.target.value)}
