...
| Testing      | pytest (backend, 250 tests)                                         |
...
目前後端共 250 個測試案例，涵蓋 JWT/JWKS 驗證、權限裝飾器、GBIF 物種搜尋、中文名稱 fallback、OAuth、Webhooks、SSR 等核心邏輯。CI pipeline 會在每次部署前自動執行。
